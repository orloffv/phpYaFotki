...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <style type="text/css" media="screen"><!--
            *{margin:0;padding:0}
            ...
            #content{width: 100%; position:relative; background: white; height: auto;}

            #footer{height: 30px; width:100%; background:#EDF2D5; width: 100%; position: relative;}
            #footer .copy {text-align: right; float: right; padding: 7px;}

            #makeMeScrollable{width:100%;height: 37px;position: relative;}	
            ...
            #albums_grid .album:hover div{color: #EDF2D5;}
    ...
    <body>
        <a href="https://github.com/orloffv/phpYaFotki" target="_blank">
            <img src="http://quickribbon.com/ribbon/2011/02/4fa2603264f9864b5b328e3e25067ea0.gif" border="0" width="150" height="150" style="position:absolute; right:0px; top:0px; margin:0px; padding:0px">
        </a>
        <div id="outline">
            <div id="header">
